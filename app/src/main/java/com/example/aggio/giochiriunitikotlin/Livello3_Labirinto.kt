...
class Livello3_Labirinto : AppCompatActivity() {
    ...
    val lab1 : Array<Array<Labirinto>> = arrayOf(
            ...
            arrayOf(Labirinto(267,120,true), Labirinto(267,360,true), Labirinto(267,600,true),Labirinto(267,840,true)),
            arrayOf(Labirinto(445,120,false), Labirinto(445,360,true), Labirinto(445,600,false),Labirinto(445,840,false)),
            arrayOf(Labirinto(622,120,true), Labirinto(622,360,true), Labirinto(622,600,true),Labirinto(622,840,false)),
            arrayOf(Labirinto(800,120,true), Labirinto(800,360,false), Labirinto(800,600,true),Labirinto(800,840,true))
    )
